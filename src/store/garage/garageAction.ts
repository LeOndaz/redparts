...
export function garageSetCurrent(vehicleId: string | null): GarageSetCurrentAction {
    return {
...
export function garageAddItem(vehicleId: string): GarageThunkAction<Promise<void>> {
...
export function garageRemoveItem(vehicleId: string): GarageThunkAction<Promise<void>> {
    return async (dispatch) => {
